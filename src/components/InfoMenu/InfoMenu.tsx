                ...
                <div className={"info-modal"}>
                    <div className={"info-modal-content"}>
                        ...
                        <ul className={"reasons-to-enlist"}>
                            <li>Are you tired of slogging through mountains of mundane tasks like some kind of unfortunate desk-bound Olympian?</li>
                            <li>Do you crave a monetary carrot dangling in front of your nose, urging you to rise above the sea of mediocrity?</li>
                            <li>Are you an aspiring millionaire or a penny-pincher on the brink of a financial revolution?</li>
                        </ul>

                        <p className={"listen-up"}>If the above applies to you, then listen up, because we've got the answer you've been waiting for!</p>

                        <p className={"information"}>
                            Welcome, all you monetary-focused bean counters, to the spectacular world of <strong>Coin Counter! </strong>
                            ...
                            Say goodbye to your mediocre existence and hello to the life of a monetarily stimulated titan!
